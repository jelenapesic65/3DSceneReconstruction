...
scene_name = "nagoya" # Scan Name
# Desired number of frames to capture DO I NEED THIS
...
# ADD THIS SECTION - Configure your data source
data_config = {
    'data_dir': './data/nagoya',  # Directory containing your RGB and depth files
    'num_frames': 60,
    'rgb_format': 'frame_{:02d}.png',  # Adjust based on your file naming
    'depth_format': 'depth_{:02d}.png', #!!!!!!!!!!!!!!!!!!!1 # Adjust based on your file naming
    #'pose_format': 'frame_{:02d}_pose.txt',  # Optional: if you have pose files !!!!! check from colmap - no need
    'depth_in_millimeters': False,  # Set to True if your depth is in mm 
    
    # Camera intrinsics - you need to set these according to your camera
    'fl_x': 1425.20648,   # Focal length x - ADJUST THIS
    'fl_y': 1514.51572,   # Focal length y - ADJUST THIS  
    'cx': full_res_width / 2,     # Principal point x (center of image)
    'cy': full_res_height / 2,    # Principal point y (center of image)
...
config = dict(
    ...
    # ADD DATA_CONFIG TO THE MAIN CONFIG
